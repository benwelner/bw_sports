...
// 2. Extracts URL from markdown [text](url) and keeps the URL
const MARKDOWN_PATTERN = /\[.*?\]\((https:\/\/raw\.githubusercontent\.com\/benwelner\/bw_sports\/main\/src\/app\/_images\/logos\/.*?)\)/g;

function processFile(filePath) {
  let content = fs.readFileSync(filePath, 'utf8');

  // Strip Markdown-wrapped URLs first
